...
<body>
    <h2>FORM DATA PEMATAUAN COVID-19</h2>
    <form action="UTS_db.html" method="POST">
        ...
        <br>
        <input type="submit" name="submit" value="submit"style="background-color: aquamarine; margin-top:30px; margin-left: 80px;">
    </form>
</body>
</html>